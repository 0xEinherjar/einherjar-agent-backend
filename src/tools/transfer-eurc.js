...
export const transferEurc = {
  name: "transferEurc",
  description: `Transfers EURC (Euro Coin) tokens from a platform user's account to a specified Ethereum wallet address. EURC is only supported on: ${SUPPORTED_CHAINS_EURC.join(", ")}.`,
  parameters: z.object({
    to: z.string().describe("Ethereum wallet address that will receive the EURC tokens."),
